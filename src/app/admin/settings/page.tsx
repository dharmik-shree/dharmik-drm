      ...
      <form onSubmit={handleSaveSettings} className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-2xl border-2 border-amber-500/40 shadow-sm space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
            ...
            <div>
              <label className="block font-semibold text-slate-700 mb-1">Company Mobile Phone (PDF)</label>
              <input
                type="text"
                value={astrologyConfig.company_mobile || ""}
                onChange={(e) => setAstrologyConfig({ ...astrologyConfig, company_mobile: e.target.value })}
            ...
            <div>
              <label className="block font-semibold text-slate-700 mb-1">Company Landline (PDF)</label>
              <input
                type="text"
                value={astrologyConfig.company_landline || ""}
                onChange={(e) => setAstrologyConfig({ ...astrologyConfig, company_landline: e.target.value })}
                placeholder="+91 98765 43210"
                className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-xl outline-none text-slate-900"
              />
            </div>
